((cssText, artDataUrl, themeConfig) => {
  ...
  const applyTheme = (root) => {
    ...
    root.style.setProperty("--dream-skin-project-prefix", cssString(THEME.projectPrefix || "Select project · "));
    root.style.setProperty("--dream-skin-project-label", cssString(THEME.projectLabel || "◉  Select project"));
    root.style.setProperty("--dream-skin-position", THEME.artPosition || "right center");
    root.style.setProperty("--dream-skin-scale", THEME.artScale || "128%");
    root.dataset.dreamSkinArtLayout = THEME.artLayout || "cover";
  };
  ...
  const cleanup = () => {
    ...
    if (document.documentElement) delete document.documentElement.dataset.dreamSkinArtLayout;
